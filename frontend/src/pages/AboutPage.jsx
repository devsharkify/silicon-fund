    ...
    <div className={`min-h-screen ${darkMode ? "bg-ink text-cream" : "bg-paper text-ink"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-[13px] mb-8" aria-label="Breadcrumb">
          <Link to="/" className={`hover:underline ${darkMode ? "text-[#2563EB]" : "text-[#2563EB]"}`}>
            Home
          </Link>
        ...
        <header className="mb-12">
          ...
          <div className="w-16 h-[3px] rounded mb-6 bg-[#2563EB]" />
          ...
          <p className="text-[15px] leading-relaxed text-slate-600 dark:text-slate-300 mt-5">
            We built Silicon Fund because the people who move capital deserve better than recycled
            press releases and breathless valuation theatre. A generation of founders, operators and
            allocators are quietly remaking tomorrow&rsquo;s economy &mdash; from deep tech in Bengaluru
            to AI infrastructure out of Hyderabad &mdash; and they need a publication that takes the
            work seriously without losing its sense of humour about it.
          </p>
          <p className="text-[15px] leading-relaxed text-slate-600 dark:text-slate-300 mt-3">
            Silicon Fund is independent, builder-first and obsessively interested in primary sources.
            We cover the deals, the regulation and the people, but we try hardest on the stories you
        ...
        >
          ...
          <p className="text-[14px] text-slate-500 dark:text-slate-400 mb-1">
            <span className="font-medium text-slate-700 dark:text-slate-200">Silicon Fund</span>
            <br />
          ...
          <p className="text-[14px] text-slate-500 dark:text-slate-400 mt-2">
            ...
            <a
              href="mailto:editor@siliconfund.in"
