  ...
  return (
    <ul className="space-y-1 mb-3 pl-1">
      {items.map((item, i) => (
        ...
        >
          <span className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-[7px] bg-[#2563EB]" />
          {item}
        </li>
      ))}
    </ul>
    ...
    <div className={`min-h-screen ${darkMode ? "bg-ink text-cream" : "bg-paper text-ink"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Para>
          ...
          Street,&rdquo; &ldquo;we&rdquo;) handles your data when you read us at siliconfund.in,
        ...
        <Section title="1. Information we collect">
          <Para>
            Most of Silicon Fund can be read without an account. When you do interact with us, here
        ...
        <Section title="3. Cookies">
          <Para>
            ...
            <Link to="/cookie-policy" className="underline text-[#2563EB]">
              Cookie Policy
            </Link>
            .
          </Para>
        ...
        <Section title="5. Your rights">
          ...
          <Para>
            ...
            <a href="mailto:legal@siliconfund.in" className="underline text-[#2563EB]">
              legal@siliconfund.in
            </a>
        ...
        <Section title="6. Children">
          <Para>
            Silicon Fund is written for adults working in or near the startup economy. We do not
            knowingly collect data from anyone under 18. If you believe a child has signed up,
            email legal@siliconfund.in and we will remove the account.
          </Para>
        </Section>
        ...
        >
          ...
          <a
            href="mailto:legal@siliconfund.in"
            className="text-[14px] font-medium hover:underline text-[#2563EB]"
          >
            legal@siliconfund.in
          </a>
        </section>
