  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-[#0A0F1E] text-slate-100" : "bg-white text-slate-800"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Para>
          This Cookie Policy explains how Silicon Fund (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
          &ldquo;our&rdquo;) uses cookies and similar tracking technologies when you visit
          thesiliconfund.in. We want to be transparent about the data we collect, why we collect
        ...
        <Section title="1. What Are Cookies?" darkMode={darkMode}>
          ...
          <Para>
            First-party cookies are set directly by Silicon Fund and are used solely to
        ...
        <Section title="3. Third-Party Cookies" darkMode={darkMode}>
          ...
          <Para>
            Articles on Silicon Fund may include embedded content from third-party platforms
        ...
        <Section title="5. Cookie Reference Table" darkMode={darkMode}>
          <Para>
            The following table lists the primary cookies used on thesiliconfund.in, their
        ...
        >
          ...
          <a
            href="mailto:privacy@thesiliconfund.in"
            className="text-[14px] font-medium hover:underline"
            style={{ color: BRAND }}
          >
            privacy@thesiliconfund.in
          </a>
        </section>
