    ...
    <div className={`min-h-screen ${darkMode ? "bg-[#0A0F1E] text-slate-100" : "bg-white text-slate-800"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Para>
          ...
          published by Silicon Fund (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
          &ldquo;our&rdquo;) on thesiliconfund.in or across any of our associated
        ...
        <Section title="1. Editorial Disclaimer" darkMode={darkMode}>
          <Para>
            ...
            Silicon Fund are intended solely for general informational and educational
          ...
          <Para>
            Nothing published on Silicon Fund should be construed as financial advice,
        ...
        <Section title="2. Accuracy &amp; Completeness" darkMode={darkMode}>
          ...
          <Para>
            ...
            at hello@thesiliconfund.in so we can investigate and issue a correction where
            warranted.
          </Para>
        </Section>
        ...
        <Section title="3. Investment Disclaimer" darkMode={darkMode}>
          <Para>
            Silicon Fund is a media company, not a registered investment advisor, broker,
          ...
          <Para>
            Silicon Fund does not hold any SEBI registration and is not regulated as a
        ...
        <Section title="4. Third-Party Links &amp; References" darkMode={darkMode}>
          ...
          <Para>
            Silicon Fund does not endorse, control, or take responsibility for the accuracy,
        ...
        <Section title="5. Forward-Looking Statements" darkMode={darkMode}>
          <Para>
            Certain content on Silicon Fund, including coverage of startup projections,
        ...
        <Section title="6. Affiliate Disclosure" darkMode={darkMode}>
          <Para>
            Silicon Fund may from time to time feature content that includes affiliate
          ...
          <Para>
            ...
            please contact us at hello@thesiliconfund.in.
          </Para>
        </Section>
        ...
        <Section title="7. No Professional Relationship" darkMode={darkMode}>
          <Para>
            Your use of Silicon Fund does not create any professional, advisory, or
            fiduciary relationship between you and Silicon Fund, its journalists, or its
        ...
        <Section title="8. Limitation of Liability" darkMode={darkMode}>
          <Para>
            To the fullest extent permitted by applicable law, Silicon Fund and its
        ...
        >
          ...
          <a
            href="mailto:hello@thesiliconfund.in"
            className="text-[14px] font-medium hover:underline"
            style={{ color: BRAND }}
          >
            hello@thesiliconfund.in
          </a>
        </section>
