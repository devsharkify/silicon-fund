...
export default function ContactPage() {
  ...
  const inputBase = `w-full rounded-lg px-3 py-2 text-[14px] border focus:outline-none focus:ring-2 focus:ring-[#2563EB]/40 ${
    darkMode
    ...
    <div className={`min-h-screen ${darkMode ? "bg-ink text-cream" : "bg-paper text-ink"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-[13px] mb-8" aria-label="Breadcrumb">
          <Link to="/" className="hover:underline text-[#2563EB]">
            Home
          </Link>
        ...
        <header className="mb-10">
          <h1 className="font-display font-bold text-[36px] sm:text-[44px] leading-tight mb-4">
            Contact Silicon Fund
          </h1>
          <div className="w-16 h-[3px] rounded mb-5 bg-[#2563EB]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          >
            ...
            <div className="space-y-3 text-[14px] text-slate-600 dark:text-slate-300">
              <p>
                ...
                <a href="mailto:editor@siliconfund.in" className="hover:underline text-[#2563EB]">
                  editor@siliconfund.in
                </a>
              </p>
              <p>
                <span className="font-semibold text-slate-700 dark:text-slate-200 block">
                ...
                <a href="mailto:advertise@siliconfund.in" className="hover:underline text-[#2563EB]">
                  advertise@siliconfund.in
                </a>
              </p>
              <p>
                <span className="font-semibold text-slate-700 dark:text-slate-200 block">
                ...
                <a href="mailto:careers@siliconfund.in" className="hover:underline text-[#2563EB]">
                  careers@siliconfund.in
                </a>
              </p>
              <p>
                <span className="font-semibold text-slate-700 dark:text-slate-200 block">
                ...
                <a href="mailto:legal@siliconfund.in" className="hover:underline text-[#2563EB]">
                  legal@siliconfund.in
                </a>
              </p>
              <p>
                <span className="font-semibold text-slate-700 dark:text-slate-200 block">
            ...
            <div className="mt-5 pt-5 border-t border-slate-200 dark:border-slate-700">
              ...
              <div className="flex flex-wrap gap-3 text-[13px]">
                <a
                  href="https://twitter.com/siliconfund_in"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/company/siliconfund"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline text-[#2563EB]"
                >
                ...
                <a
                  href="https://instagram.com/siliconfund.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline text-[#2563EB]"
                >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center px-4 py-2 rounded-lg text-[14px] font-semibold text-white bg-[#2563EB] hover:opacity-90 transition"
              >
                Send message
              </button>
              {toast && (
                <p className="text-[13px] mt-2 text-[#2563EB] font-medium">{toast}</p>
              )}
            </form>
          </section>
        </div>
        ...
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 text-[14px] font-medium hover:underline text-[#2563EB]"
        >
