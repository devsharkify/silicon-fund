          ...
          {idCardData && (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="text-lg font-bold">Silicon Fund</h3>
                  <p className="text-xs text-orange-200">Citizen Reporter</p>
                </div>
                <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                  <img src="/logo.svg" alt="Silicon Fund" className="w-8 h-8 object-contain" />
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-white/20 text-center">
                <p className="text-xs text-orange-200">This is a digital ID for Silicon Fund citizen reporters</p>
              </div>
            </div>
          )}
