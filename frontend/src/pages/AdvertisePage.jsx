  ...
  const adOptions = [
    {
      ...
      description:
        "A clearly-marked slot at the top or middle of the Silicon Fund daily, delivered each morning to founders, investors and operators who actually open their inbox before scrolling X.",
    },
    {
      icon: "#",
      title: "Site Display",
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <header className="mb-10">
          <h1 className="font-display font-bold text-[36px] sm:text-[44px] leading-tight mb-4">
            Advertise on Silicon Fund
          </h1>
          <div className="w-16 h-[3px] rounded mb-5 bg-[#2563EB]" />
          <Para>
            Silicon Fund is where new money meets new ideas &mdash; a daily read for the people
        ...
        {/* Why Silicon Fund */}
        <Section title="Why Silicon Fund">
          <Para>
            ...
            elsewhere. They open the Silicon Fund daily newsletter for sharp, original analysis on
        ...
        >
          ...
          <p className="text-[14px] text-slate-500 dark:text-slate-400">
            ...
            <a
              href="mailto:advertise@siliconfund.in"
              className="hover:underline font-medium text-[#2563EB]"
            >
