...
export default function TermsOfService() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-[#0A0F1E] text-slate-100" : "bg-white text-slate-800"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">

        {/* Breadcrumb */}
        <nav className="flex items-center gap-2 text-[13px] mb-8" aria-label="Breadcrumb">
          <Link to="/" className={`hover:underline ${darkMode ? "text-blue-400" : "text-[#2563EB]"}`}>
            Home
          </Link>
        ...
        <Para>
          Welcome to Silicon Fund. These Terms of Service (&ldquo;Terms&rdquo;) govern your
          access to and use of thesiliconfund.in and any related services, mobile applications, or
          publications operated by Silicon Fund (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
        ...
        <Section title="1. Acceptance of Terms" darkMode={darkMode}>
          <Para>
            By visiting, reading, or otherwise using Silicon Fund&rsquo;s website, applications,
        ...
        <Section title="2. Use of Content" darkMode={darkMode}>
          <Para>
            All content published on Silicon Fund &mdash; including but not limited to articles,
            analysis, data visualisations, infographics, photographs, video, audio, and design elements
            &mdash; is the exclusive intellectual property of Silicon Fund or its licensors, and
          ...
          <BulletList items={[
            ...
            "Share article links on social media with proper attribution to Silicon Fund",
        ...
        <Section title="4. Intellectual Property" darkMode={darkMode}>
          <Para>
            All intellectual property rights in and to Silicon Fund &mdash; including our brand
            name, logo, taglines, design system, editorial content, databases, and software &mdash; are
            owned by or licensed to Silicon Fund. Nothing in these Terms grants you any right,
          ...
          <Para>
            Silicon Fund name and logo are registered trademarks. You may not use our trademarks
        ...
        <Section title="5. Disclaimer of Warranties" darkMode={darkMode}>
          <Para>
            Silicon Fund provides its services on an &ldquo;as is&rdquo; and &ldquo;as
        ...
        <Section title="6. Limitation of Liability" darkMode={darkMode}>
          <Para>
            To the maximum extent permitted by applicable law, Silicon Fund, its directors,
        ...
        <Section title="7. Third-Party Links &amp; References" darkMode={darkMode}>
          <Para>
            ...
            provided for reference and convenience only. Silicon Fund does not endorse, control,
        ...
        <Section title="8. Governing Law &amp; Dispute Resolution" darkMode={darkMode}>
          <Para>
            ...
            or your use of Silicon Fund&rsquo;s services.
          </Para>
          <Para>
            Before initiating any legal proceeding, both parties agree to attempt to resolve the dispute
            informally by contacting us at legal@thesiliconfund.in. We will make good-faith efforts
        ...
        <Section title="9. Indemnification" darkMode={darkMode}>
          <Para>
            You agree to indemnify, defend, and hold harmless Silicon Fund and its officers,
        ...
        >
          ...
          <p className="text-[14px] text-slate-500 dark:text-slate-400 mb-1">
            Silicon Fund, Hyderabad, Telangana, India
          </p>
          <a
            href="mailto:legal@thesiliconfund.in"
