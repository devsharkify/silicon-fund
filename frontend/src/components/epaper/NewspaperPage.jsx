const Masthead = ({ date, fD, slot }) => {
  ...
  return (
    <div style={{ marginBottom: "6px" }}>
      <div style={{ textAlign: "center", padding: "8px 0 4px", borderBottom: "5px double #2563EB" }}>
        <div style={{ fontSize: "48px", fontWeight: 900, letterSpacing: "6px", fontFamily: "'Fraunces', Georgia, serif", color: "#2563EB", lineHeight: 1, textTransform: "uppercase" }}>SILICON FUND</div>
        <div style={{ fontSize: "8px", color: "#888", fontFamily: "system-ui", letterSpacing: "3px", textTransform: "uppercase", marginTop: "3px" }}>
          Startup Intelligence, Daily.
        </div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: "9px", color: "#555", fontFamily: "system-ui", padding: "4px 0", borderBottom: "2px solid #1a1a1a" }}>
        ...
        <span style={{ letterSpacing: "2px", textTransform: "uppercase", fontSize: "8px", color: "#2563EB", fontWeight: 700 }}>{edLabel}</span>
        <span>siliconfund.in</span>
      </div>
    </div>
  );
};
...
const InnerHeader = ({ title, date, pageNum, fD, slot }) => {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", borderBottom: "3px solid #1a1a1a", paddingBottom: "4px", marginBottom: "8px" }}>
      <span style={{ fontSize: "13px", fontWeight: 900, letterSpacing: "3px", textTransform: "uppercase", color: "#2563EB" }}>SILICON FUND</span>
...
const CmykFooter = ({ pageNum, totalPages, date, fD }) => (
  <div style={{ marginTop: "auto", paddingTop: "6px", borderTop: "2px solid #1a1a1a", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
    ...
    <div style={{ fontSize: "7px", color: "#999", fontFamily: "system-ui" }}>siliconfund.in &bull; Page {pageNum}/{totalPages} &bull; {fD(date)}</div>
    <div style={{ display: "flex", gap: "3px" }}>
