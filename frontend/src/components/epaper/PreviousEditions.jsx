          ...
          {recentDates.map(date => {
            ...
            return (
              <div key={date} data-testid={`archive-card-${date}`}
                style={{ background: "#2a2a2a", border: selectedDate === date ? "2px solid #2563EB" : "1px solid #3a3a3a", borderRadius: "8px", padding: "14px 10px", textAlign: "center" }}>
                <div style={{
                  width: "44px", height: "44px", borderRadius: "50%",
                  background: selectedDate === date ? "rgba(196,30,30,0.2)" : "#333",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 8px", fontSize: "20px", fontWeight: 900,
                  color: selectedDate === date ? "#2563EB" : "#ccc", fontFamily: "'Fraunces', serif",
                }}>{getDayNum(date)}</div>
                    ...
                    return (
                      <button key={s} data-testid={`archive-${date}-${s}`}
                        ...
                        style={{
                          ...
                          background: isActive ? "#2563EB" : ed ? "#3a3a3a" : "#2a2a2a",
        ...
        {months.length > 0 && (
          <div style={{ borderTop: "1px solid #333", paddingTop: "16px", paddingBottom: "24px" }}>
            <button data-testid="archive-show-older" onClick={() => setShowOlder(!showOlder)}
              style={{ display: "flex", alignItems: "center", gap: "8px", background: "none", border: "none", cursor: "pointer", color: "#2563EB", fontSize: "14px", fontWeight: 700, padding: "0", marginBottom: showOlder ? "16px" : "0" }}>
                        ...
                        return (
                          <button key={`${e.date}_${e.slot}`} data-testid={`archive-link-${e.date}-${e.slot}`}
                            ...
                            style={{
                              ...
                              border: `1px solid ${isActive ? "#2563EB" : "#444"}`,
